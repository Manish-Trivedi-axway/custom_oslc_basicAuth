...
public class ResourcesService
{
    ...
    @Operation(
        summary = "Query capability for resources of type {" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + Oslc_amDomainConstants.RESOURCE_TYPE + "\">" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<Resource> resources = delegate.queryResources(httpServletRequest, where, prefix, paging, page, pageSize);
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            final List<Resource> resources = delegate.ResourceSelector(httpServletRequest, terms);
            if (resources!= null) {
                ...
                for (Resource resource : resources) {
                    ...
                    // Start of user code ResourceSelector_setResponse
    ...
    @Produces({OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_JSON_LD, OslcMediaType.TEXT_TURTLE, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON})
    @Operation(
        summary = "Creation factory for resources of type {" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "}",
        description = "Creation factory for resources of type {" + "<a href=\"" + Oslc_amDomainConstants.RESOURCE_TYPE + "\">" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "</a>" + "}" +
            ", with respective resource shapes {" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_amDomainConstants.RESOURCE_PATH + "\">" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "</a>" + "}",
        responses = { 
    ...
    {
        Resource newResource = delegate.createResource(httpServletRequest, aResource);
        httpServletResponse.setHeader("ETag", delegate.getETagFromResource(newResource));
