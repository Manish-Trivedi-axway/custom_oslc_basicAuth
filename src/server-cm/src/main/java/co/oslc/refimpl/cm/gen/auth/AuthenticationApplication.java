...
package co.oslc.refimpl.cm.gen.auth;
...
public class AuthenticationApplication implements Application {
    ...
    public final static String APPLICATION_NAME = "CM";
    public final static String OAUTH_REALM = "CM";
    protected final static String APPLICATION_CONNECTOR_SESSION_ATTRIBUTE = "co.oslc.refimpl.cm.gen.auth.ApplicationConnector";
    protected final static String APPLICATION_CONNECTOR_ADMIN_SESSION_ATTRIBUTE = "co.oslc.refimpl.cm.gen.auth.AdminSession";
