...
public class SpCatalogIT {
    ...
    private static final String URI_SPC = "http://codebeamer.arorian.com:8083/services/catalog/singleton";
    ...
    public void testBasicAuthOK() {
        given().auth().basic("DPTuser", "DPTAdmin").
            when().get(URI_SPC).
            then().statusCode(200);
    }
    ...
    public void testServesRootServices() {
        ...
        .when()
            .get("http://codebeamer.arorian.com:8083/services/rootservices")
        .then()
            .statusCode(200)
            .contentType("application/rdf+xml")
//            .log().all()
